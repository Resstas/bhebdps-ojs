describe("About this (about_this.js)", function() {
  it("'this' inside a method", function () {
    let person = {
      name: 'bob',
      intro: function () {
        return "Hello, my name is " + this.name;  // this ссылается на объект person
      }
    }
  ...
  it("'this' on unattached function", function () {
    ...
    window.globalName = 'Peter';  // Устанавливаем глобальную переменную
  ...
  it("'this' set explicitly", function () {
    ...
    let message = person.intro.call({name: "Frank"});  // Явно устанавливаем this на объект {name: "Frank"}
